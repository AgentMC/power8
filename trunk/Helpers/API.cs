...
// ReSharper restore UnusedParameter.Local
        ...
        public enum FileAccessRights : uint
        {
            ...
            /// <summary>	For a file object, the right to append data to the file. (For local files, 
            /// write operations will not overwrite existing data if this flag is specified without 
            /// FILE_WRITE_DATA.) For a directory object, the right to create a subdirectory 
            /// (FILE_ADD_SUBDIRECTORY).	</summary>
            FILE_APPEND_DATA = 4,

            /// <summary>	For a named pipe, the right to create a pipe.	</summary>
            FILE_CREATE_PIPE_INSTANCE = 4,

            /// <summary>	For a directory, the right to delete a directory and all the files it contains, 
            /// including read-only files.	</summary>
            FILE_DELETE_CHILD = 64,

            /// <summary>	For a native code file, the right to execute the file. This access right given 
            /// to scripts may cause the script to be executable, depending on the script interpreter.	</summary>
            FILE_EXECUTE = 32,
            ...
            /// <summary>	For a file object, the right to read the corresponding file data. For a directory 
            /// object, the right to read the corresponding directory data.	</summary>
            FILE_READ_DATA = 1,

            /// <summary>	The right to read extended file attributes.	</summary>
            FILE_READ_EA = 8,

            /// <summary>	For a directory, the right to traverse the directory. By default, users are 
            /// assigned the BYPASS_TRAVERSE_CHECKING privilege, which ignores the FILE_TRAVERSE access right. 
            /// See the remarks in File Security and Access Rights for more information.	</summary>
            FILE_TRAVERSE = 32,

            /// <summary>	The right to write file attributes.	</summary>
            FILE_WRITE_ATTRIBUTES = 256,

            /// <summary>	For a file object, the right to write data to the file. For a directory object, the 
            /// right to create a file in the directory (FILE_ADD_FILE).	</summary>
            FILE_WRITE_DATA = 2,
            ...
            /// <summary>	The right to read the information in the object's security descriptor, not including 
            /// the information in the system access control list (SACL).	</summary>
            READ_CONTROL = 0x00020000,

            /// <summary>	The right to modify the discretionary access control list (DACL) in the object's 
            ...
            /// <summary>	The right to use the object for synchronization. This enables a thread to wait until 
            /// the object is in the signaled state. Some object types do not support this access right.	</summary>
